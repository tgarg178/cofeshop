...
export default function Footer() {
 ...
 <footer className="bg-primary text-white py-5 footermain">
  ...
  <div className="col-lg-4 col-md-6 paddingfootermid d-flex flex-column">
    ...
    <a className="btn btn-link text-white text-decoration-none  f18 footerquiclink" href="/">    <i className="bi bi-chevron-right me-1"></i> Home</a>
    <a className="btn btn-link text-white  text-decoration-none f18 footerquiclink" href="/about">     <i className="bi bi-chevron-right me-1"></i>    About</a>
    <a className="btn btn-link text-white  text-decoration-none f18 footerquiclink" href="/product">    <i className="bi bi-chevron-right me-1"></i>Products</a>
   
    <a className="btn btn-link text-white  text-decoration-none f18 footerquiclink" href="/contact">    <i className="bi bi-chevron-right me-1"></i>Contact</a></div>
...
<div className="copyright max90 border-top pt-3">
  <div className="row">
    <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">© 
      <a className="border-bottom text-white bold text-decoration-none" href="#">DEVEX</a>, 
